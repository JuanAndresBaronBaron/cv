...
const I18N = {
  en: {
    ...
    t9_h: "SAP SuccessFactors", t9_p: "Integration across the SuccessFactors module surface via its OData API.",
  ...
  es: {
    ...
    t9_h: "SAP SuccessFactors", t9_p: "Integración con los módulos de SuccessFactors a través de su API OData.",
  ...
  fr: {
    ...
    t9_h: "SAP SuccessFactors", t9_p: "Intégration avec les modules SuccessFactors via son API OData.",
