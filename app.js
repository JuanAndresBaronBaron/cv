...
const I18N = {
  en: {
    ...
    rotate: ["SAP integrations", "SuccessFactors automation", "AI assistants", "scalable systems", "cloud infrastructure"],
    hero_blurb: "5+ years building and integrating enterprise software on SAP BTP and SuccessFactors, paired with AI-driven automation, for global markets.",
    about_text: "I build and integrate enterprise software on SAP — SuccessFactors over OData, Cloud Foundry on SAP HANA, SAPUI5 / Fiori interfaces — and pair it with AI grounded in the business engine rather than model guesswork, turning manual enterprise processes into automated ones.",
    ...
    t8_h: "SAP Integration & UI", t8_p: "Secure, throttle-aware integration between SAP and the systems around it — OData services, SAML Bearer authentication and BTP destinations — with SAPUI5 / Fiori front ends on top.",
    t9_h: "SAP SuccessFactors", t9_p: "Integration across the SuccessFactors module surface — its OData API for data, Intelligent Services for HR life events.",
    t2_h: "Frontend & Mobile", t2_p: "Dynamic web UIs and cross-platform mobile apps.",
    t3_h: "Cloud, DevOps & CI/CD", t3_p: "Infrastructure as code, automated build-test-deploy pipelines and reproducible environments across the major clouds.",
    t4_h: "CI/CD Pipelines", t4_p: "Automated build, test & deploy — ship with confidence.",
    t5_h: "AI Implementation & Automation", t5_p: "Assistants and agent workflows grounded in the business engine rather than model guesswork — RAG knowledge bases and end-to-end process automation.",
    t6_h: "SAP BTP", t6_p: "Enterprise software on SAP Business Technology Platform — Java services delivered to Cloud Foundry on SAP HANA, secured with XSUAA and SAP IAS.",
  ...
  es: {
    ...
    rotate: ["integraciones SAP", "automatización de SuccessFactors", "asistentes con IA", "sistemas escalables", "infraestructura cloud"],
    hero_blurb: "Más de 5 años construyendo e integrando software empresarial sobre SAP BTP y SuccessFactors, combinado con automatización mediante IA, para mercados globales.",
    about_text: "Construyo e integro software empresarial sobre SAP — SuccessFactors vía OData, Cloud Foundry sobre SAP HANA, interfaces SAPUI5 / Fiori — y lo combino con IA fundamentada en el motor de negocio en lugar de suposiciones del modelo, convirtiendo procesos empresariales manuales en procesos automatizados.",
    ...
    t8_h: "Integración SAP y UI", t8_p: "Integración segura y resistente a límites de tasa entre SAP y los sistemas de su entorno: servicios OData, autenticación SAML Bearer y destinations de BTP, con interfaces SAPUI5 / Fiori encima.",
    t9_h: "SAP SuccessFactors", t9_p: "Integración con los módulos de SuccessFactors: su API OData para los datos e Intelligent Services para los eventos de RR. HH.",
    t2_h: "Frontend y Móvil", t2_p: "Interfaces web dinámicas y apps móviles multiplataforma.",
    t3_h: "Cloud, DevOps y CI/CD", t3_p: "Infraestructura como código, pipelines automatizados de build, test y despliegue, y entornos reproducibles en las principales nubes.",
    t4_h: "Pipelines CI/CD", t4_p: "Build, test y deploy automatizados — despliega con confianza.",
    t5_h: "Implementación de IA y Automatización", t5_p: "Asistentes y flujos con agentes fundamentados en el motor de negocio en lugar de suposiciones del modelo: bases de conocimiento RAG y automatización de procesos de extremo a extremo.",
    t6_h: "SAP BTP", t6_p: "Software empresarial sobre SAP Business Technology Platform: servicios Java desplegados en Cloud Foundry sobre SAP HANA, protegidos con XSUAA y SAP IAS.",
  ...
  fr: {
    ...
    rotate: ["des intégrations SAP", "l'automatisation SuccessFactors", "des assistants IA", "des systèmes évolutifs", "une infra cloud"],
    hero_blurb: "Plus de 5 ans à construire et intégrer des logiciels d'entreprise sur SAP BTP et SuccessFactors, associés à de l'automatisation par IA, pour des marchés mondiaux.",
    about_text: "Je construis et intègre des logiciels d'entreprise sur SAP — SuccessFactors via OData, Cloud Foundry adossé à SAP HANA, interfaces SAPUI5 / Fiori — et j'y associe une IA fondée sur le moteur métier plutôt que sur les suppositions du modèle, transformant des processus d'entreprise manuels en processus automatisés.",
    ...
    t8_h: "Intégration SAP & UI", t8_p: "Intégration sécurisée et résistante à la limitation de débit entre SAP et les systèmes environnants : services OData, authentification SAML Bearer et destinations BTP, avec des interfaces SAPUI5 / Fiori par-dessus.",
    t9_h: "SAP SuccessFactors", t9_p: "Intégration avec les modules SuccessFactors : son API OData pour les données et Intelligent Services pour les événements RH.",
    t2_h: "Frontend & Mobile", t2_p: "Interfaces web dynamiques et apps mobiles multiplateformes.",
    t3_h: "Cloud, DevOps & CI/CD", t3_p: "Infrastructure as code, pipelines automatisés de build, test et déploiement, et environnements reproductibles sur les principaux clouds.",
    t4_h: "Pipelines CI/CD", t4_p: "Build, test et déploiement automatisés — livrez en confiance.",
    t5_h: "Implémentation IA & Automatisation", t5_p: "Des assistants et workflows d'agents fondés sur le moteur métier plutôt que sur les suppositions du modèle : bases de connaissances RAG et automatisation de processus de bout en bout.",
    t6_h: "SAP BTP", t6_p: "Logiciels d'entreprise sur SAP Business Technology Platform : services Java déployés sur Cloud Foundry adossés à SAP HANA, sécurisés par XSUAA et SAP IAS.",
